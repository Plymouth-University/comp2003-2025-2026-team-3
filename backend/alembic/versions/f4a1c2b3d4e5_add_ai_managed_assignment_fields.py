...
def downgrade() -> None:
    ...
    op.drop_column("ticket_ai_state", "ai_managed_set_at", schema=AI_SCHEMA)
    op.drop_column("ticket_ai_state", "ai_managed_reason", schema=AI_SCHEMA)
    op.drop_column("ticket_ai_state", "ai_managed_profile_id", schema=AI_SCHEMA)

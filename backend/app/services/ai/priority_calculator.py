...
def calculate_priority_score(text: str, category: str, semantic_scores: dict) -> int:
    """
...
def calculate_priority_scores_batch(
    texts: list[str], categories: list[str], semantic_scores_list: list[dict]
) -> list[int]:
    """
    ...
    category_weights = {
        cat: get_dynamic_category_weight(cat) for cat in set(categories)
    }

...
export function TicketListContainer(onOpenTicket) {
    let collapsed = false;
    let sortByPriority = "desc";
    let sortByDate = "asc";
    ...
    const toggleCollapse = () => {
        collapsed = !collapsed;
        collapseImg.setAttribute("src", collapsed ? "./assets/collapse-icon/deCollapse.png" : "./assets/collapse-icon/collapseTriangle.png");
        render();
    };
...
//# sourceMappingURL=TicketListContainer.js.map